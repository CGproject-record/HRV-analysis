...
dnn_train<-read.csv('dnn for si over 1 in cgmh train result ver1 20230223.csv',header = T)
head(dnn_train)
...
dnn_test<-read.csv('dnn for si over 1 in cgmh test result ver1 20230223.csv',header = T)
head(dnn_test)
